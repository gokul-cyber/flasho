...
const AddAmazonPinpointEmail = (props: any) => {
  ...
  const connect = () => {
    ...
    axiosInstance
      .post('/v1/settings/initialize_pinpoint_email', formData)
      .then(() => {
        notification({
          title: `Amazon Pinpoint Email ${
            isReconfigure ? 'Reconfigured' : 'Connected'
          }`,
          description: `Amazon Pinpoint Email is ${
            isReconfigure ? 'reconfigured' : 'connected'
          } successfully`,
          status: 'success'
        });
        ...
        dispatch.credentials.ADD_CREDENTIALS({
          service_name: SERVICE_TYPES.PINPOINT_EMAIL,
  ...
  const [formData, setFormData] =
    useState<PINPOINT_EMAIL_CREDENTIALS>(defaultFormData);

  useEffect(() => {
    if (isReconfigure && open && !isOnboarding) {
      dispatch.credentials.LOAD_CREDENTIALS('pinpoint_email');
      console.log('Fetching from Modal Pinpoint Email');
      setFormData(credentials['pinpoint_email'] as PINPOINT_EMAIL_CREDENTIALS);
    }
  }, [isReconfigure]);
      ...
      <div className="modal_container">
        <div className="modal_header">
          <p className="modal_title">
            {isReconfigure ? 'Reconfigure' : 'Connect'} your Amazon Pinpoint
            Email
          </p>
          <img
            ...
            <div className="v-stack">
              ...
              <div className="h_stack mb-1.5">
                ...
                <input
                  ...
                  id="pinpoint_source_email_address"
...
AddAmazonPinpointEmail.propTypes = {
  open: PropTypes.bool,
...
export default AddAmazonPinpointEmail;
